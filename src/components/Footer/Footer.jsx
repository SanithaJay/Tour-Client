...
const Footer = () =>
{
    return (
        <div>
            <footer className="text-center text-lg-start bg-body-white text-muted">

                <section className="">
                    <div className="container text-center text-md-start mt-5">
                        <div className="row mt-3">
                            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                <img src={ image } alt="logo" className="footer-image" />
                                <p>
                            ...
                            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                ...
                                <p className="fw-bold">
                                    <i className="bi bi-telephone text-danger m-1"></i> Phone: <span className="fw-normal">+ 91 8075126134</span>
                                </p>
