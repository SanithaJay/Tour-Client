        ...
        <div>
          ...
          <div className="row mt-5">
            ...
            { isValidTourData ? (
                    ...
                    <div className="card-body">
                      <div className="d-flex justify-content-between align-items-center mb-2">
                        <div className="d-flex">
                          <span className="text-warning mr-2 "><i className="bi bi-geo-alt"></i></span>
                          <span className="fw-bold">{ tour.city }</span>
                        </div>
                        <div className="d-flex ml-auto">
                          <span className="text-warning"><i class="bi bi-star"></i></span>
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        <h6 className="text-success">${ tour.price } / person</h6>
              ...
              <h6 className="text-center">No tours available</h6>
            ) }
          </div>
        </div>
      </div>
